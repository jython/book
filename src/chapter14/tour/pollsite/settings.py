...
DATABASE_NAME = 'pollsite'             # Or path to database file if using sqlite3.
DATABASE_USER = 'lsoto'             # Not used with sqlite3.
...
SECRET_KEY = '0v)oo7=405)w^7d(j^8f@tv2m*dj@-198^r9oz0=9k-bz&79kx'
